// features/group-games-selection/group-games-selection.hooks.ts
...
} from "./group-games-selection.store";
import {
  toggleGroupGame,
  clearSelectedGroupGames,
} from "./group-games-selection.actions";
import type { FixtureId } from "./group-games-selection.types";
...
export function useSelectedGroupGames(): {
  games: Array<{ fixtureId: number; game: any }>;
  count: number;
  hasAnyGame: boolean;
} {
