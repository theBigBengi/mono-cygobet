// features/group-games-selection/group-games-selection.actions.ts
// Explicit action functions for group games operations.
// Updates atom AND persists to storage (ONLY write path).

import { selectedGroupGamesAtom } from "./group-games-selection.store";
import {
  saveGroupGamesToStorage,
  clearGroupGamesStorage,
} from "./group-games-selection.persistence";
