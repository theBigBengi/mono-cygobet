...
pnpm --filter api seed [flags...]
pnpm --filter api seed:dry [flags...]
...
pnpm --filter api seed -- --countries --leagues --teams --seasons
```
...
pnpm --filter api seed -- --bookmakers --countries

# Then seed dependent entities
pnpm --filter api seed -- --leagues --teams --seasons

# Finally seed fixtures and odds
pnpm --filter api seed -- --fixtures --odds
```
